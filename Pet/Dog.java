...
public class Dog extends Pet{
    ...
    public Dog(int id, String name, boolean isForSale, int age, double price, int health, int mood, int hunger){
        super(id,name,"dog",isForSale,age,price, health, mood, hunger);
